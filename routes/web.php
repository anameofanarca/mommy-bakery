...
Route::get('/menu/nasibox', function () {
    $products = Product::where('is_active', true)->where('category', 'Nasi Box')->latest()->get();
    return view('menu.nasibox', compact('products'));
})->name('menu.nasibox');

Route::get('/menu/tumpeng', function () {
    $products = Product::where('is_active', true)->where('category', 'Tumpeng')->latest()->get();
    return view('menu.tumpeng', compact('products'));
})->name('menu.tumpeng');

Route::get('/menu/prasmanan', function () {
    $products = Product::where('is_active', true)->where('category', 'Prasmanan')->latest()->get();
    return view('menu.prasmanan', compact('products'));
})->name('menu.prasmanan');

Route::get('/menu/bakery', function () {
    $products = Product::where('is_active', true)->where('category', 'Bakery')->latest()->get();
    return view('menu.bakery', compact('products'));
})->name('menu.bakery');

Route::get('/menu/snackbox', function () {
    $products = Product::where('is_active', true)->where('category', 'Snack Box')->latest()->get();
...
Route::get('/admin/dashboard', function () {
    ...
    $totalProducts = Product::where('is_active', true)->count(); // ← yang kurang
