...
<section class="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-14 items-center">
    <div>
...
<section class="max-w-7xl mx-auto px-6 py-24">
    ...
    <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
            <img src="{{ asset('images/nasibox.jpeg') }}" alt="Nasi Box" class="w-full h-60 object-cover">
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
            <img src="{{ asset('images/timpeng.jpg') }}" alt="Tumpeng" class="w-full h-60 object-cover">
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
            <img src="{{ asset('images/product/Paket Prasmanan 50 Pax.png') }}" alt="Prasmanan" class="w-full h-60 object-cover">
