...
>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        @forelse($products as $product)
            @php
                $categoryName = strtolower(trim($product->category ?? ''));
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <div class="flex justify-between items-end mt-4">
                        ...
                        @if ($categoryName === 'snack box' || $categoryName === 'snackbox')
                            <button
                                type="button"
                                @click="openCustomizer({{ $product->id }}, '{{ addslashes($product->name) }}', {{ (int) $product->price }}, {{ $limit }})"
    ...
    >
        <div
            class="bg-[#FAF6F0] w-full max-w-md rounded-3xl overflow-hidden shadow-2xl border border-black/5 flex flex-col max-h-[85vh]"
        ...
        >
            ...
            <form
                method="POST"
                :action="'{{ url('/cart/add') }}/' + selectedProductId"
