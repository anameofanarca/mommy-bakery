...
<div class="max-w-7xl mx-auto px-4 md:px-8 py-6">
    ...
    <p class="text-xs text-[#4A2C2A] mb-4">
        ...
        <span class="mx-1 text-gray-400">&gt;</span> 
        <span class="text-[#A04545] font-semibold">Nasi Box</span>
    </p>
    ...
    <div class="flex flex-col md:flex-row md:items-center gap-4 mb-8">
        ...
        <div class="flex flex-wrap gap-2 text-xs font-medium">
            ...
            <a href="{{ url('/menu/nasibox') }}" class="bg-[#A04545] text-white px-4 py-2 rounded-md transition-colors inline-block text-center shadow-sm">Nasi Box</a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
            ...
            <div class="p-4 flex flex-col flex-grow">
                ...
                <p class="text-xs text-gray-500 mt-1 flex-grow line-clamp-2">Nasi putih dengan ayam bakar bumbu spesial, lalapan, dan sambal.</p>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
            <div class="h-48 overflow-hidden">
                <img src="{{ asset('images/product/Nasi Box_AyamGulai.png') }}" class="w-full h-full object-cover" alt="Nasi Box Ayam Gulai">
            </div>
            <div class="p-4 flex flex-col flex-grow">
                <span class="text-xs font-medium text-[#A04545]">Nasi Box</span>
                <h3 class="text-lg font-bold text-[#4A2C2A] mt-1 line-clamp-1">Nasi Box Ayam Gulai</h3>
                <p class="text-xs text-gray-500 mt-1 flex-grow line-clamp-2">Nasi dengan ayam gulai empuk dan bumbu kuah rempah khas Padang.</p>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
            <div class="h-48 overflow-hidden">
                <img src="{{ asset('images/product/Nasi Box_IkanGoreng.png') }}" class="w-full h-full object-cover" alt="Nasi Box Ikan Goreng">
            </div>
            <div class="p-4 flex flex-col flex-grow">
                <span class="text-xs font-medium text-[#A04545]">Nasi Box</span>
                <h3 class="text-lg font-bold text-[#4A2C2A] mt-1 line-clamp-1">Nasi Box Ikan Goreng</h3>
                <p class="text-xs text-gray-500 mt-1 flex-grow line-clamp-2">Nasi dengan ikan goreng garing, sambal dan lalapan segar.</p>
                
                <div class="flex justify-between items-end mt-4">
                    <div>
                        <span class="block text-base font-bold text-[#A04545]">Rp 28.000</span>
                        <span class="text-[10px] text-gray-400">1 porsi</span>
                    </div>
                    <a href="#" class="text-xs font-medium text-[#A04545] hover:underline flex items-center gap-1 mb-1">
                        Lihat Detail <span class="text-sm">→</span>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
            <div class="h-48 overflow-hidden">
                <img src="{{ asset('images/product/Nasi Box_Telur.png') }}" class="w-full h-full object-cover" alt="Nasi Box Telur">
            </div>
            <div class="p-4 flex flex-col flex-grow">
                <span class="text-xs font-medium text-[#A04545]">Nasi Box</span>
                <h3 class="text-lg font-bold text-[#4A2C2A] mt-1 line-clamp-1">Nasi Box Telur</h3>
                <p class="text-xs text-gray-500 mt-1 flex-grow line-clamp-2">Nasi dengan Telur Dadar tebal khas Mommy Catering.</p>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 flex flex-col">
            <div class="h-48 overflow-hidden">
                <img src="{{ asset('images/product/Nasi Box_IkanBakar.png') }}" class="w-full h-full object-cover" alt="Nasi Box Ikan Bakar">
            </div>
            <div class="p-4 flex flex-col flex-grow">
                <span class="text-xs font-medium text-[#A04545]">Nasi Box</span>
                <h3 class="text-lg font-bold text-[#4A2C2A] mt-1 line-clamp-1">Nasi Box Ikan Bakar</h3>
                <p class="text-xs text-gray-500 mt-1 flex-grow line-clamp-2">Nasi dengan ikan bakar pilihan, matriks, dan lalapan segar.</p>
