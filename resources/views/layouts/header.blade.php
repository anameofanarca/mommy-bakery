<header class="border-b border-[#E5DED3] bg-[#F8F4EC]">
    <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <nav class="hidden md:flex gap-8 text-sm font-medium text-[#52443E]">
            <a href="{{ url('/') }}" class="{{ request()->is('/') ? 'text-[#8B3A3A] font-semibold' : 'hover:text-[#8B3A3A] transition' }}">Home</a>
            <a href="{{ url('/menu') }}" class="{{ request()->is('menu*') || request()->segment(1) == 'menu' ? 'text-[#8B3A3A] font-semibold' : 'hover:text-[#8B3A3A] transition' }}">Menu</a>
            <a href="#" class="{{ request()->is('catering*') ? 'text-[#8B3A3A] font-semibold' : 'hover:text-[#8B3A3A] transition' }}">Catering</a>
            <a href="#" class="{{ request()->is('about*') ? 'text-[#8B3A3A] font-semibold' : 'hover:text-[#8B3A3A] transition' }}">About</a>
            <a href="#" class="{{ request()->is('contact*') ? 'text-[#8B3A3A] font-semibold' : 'hover:text-[#8B3A3A] transition' }}">Contact</a>
        </nav>
