...
<div class="max-w-6xl mx-auto px-4 md:px-8 py-8">
    ...
    <h1 class="text-3xl font-serif font-bold text-[#4A2C2A] mb-2">
        Checkout
    </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div class="md:col-span-2 bg-[#ECE3BF] rounded-3xl p-6 border border-gray-100 shadow-sm">
            <form id="checkoutForm" action="{{ route('checkout.payment.save') }}" method="POST">
                ...
                {{-- Sesuai CheckoutController: default delivery --}}
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-[#7A5C4A] mt-2">
                            Alamat otomatis diambil dari profile. Kamu tetap bisa mengubahnya untuk pesanan ini.
                        </p>
                    </div>
        ...
        <div class="bg-[#ECE3BF] rounded-xl p-6 border border-[#d8c99d] shadow-lg sticky top-6">
            ...
            <div class="space-y-5">
                @if(isset($items) && count($items) > 0)
                    <div class="space-y-3">
                        @foreach($items as $item)
                            <div class="flex justify-between gap-3 text-sm text-[#451C07]">
                                <div>
                                    <p class="font-semibold">
                                        {{ $item['product']->name }}
                                    </p>
                                    <p class="text-xs text-[#7A5C4A]">
                ...
                <div class="flex justify-between text-sm text-[#451C07]">
                    <span>Ongkir</span>
                    <span class="font-bold">
                        Rp {{ number_format($deliveryFee ?? 0, 0, ',', '.') }}
                    </span>
                </div>
